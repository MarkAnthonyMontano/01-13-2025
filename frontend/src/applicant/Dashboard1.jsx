...
const Dashboard1 = (props) => {
  ...
  useEffect(() => {
    const fetchActiveYearAndAvailability = async () => {
      const yearRes = await axios.get(`${API_BASE_URL}/api/school-years`);
      const activeYear = yearRes.data.find(y => y.status === 1);

      if (activeYear) {
        setActiveYearId(activeYear.year_id);

        const availRes = await axios.get(
          `${API_BASE_URL}/api/programs/availability/${activeYear.year_id}`
        );
  ...
  const availabilityMap = React.useMemo(() => {
    ...
    programAvailability.forEach(p => {
      map[p.program_id] = {
        remaining: p.max_slots - p.total_applicants,
        isFull: p.total_applicants >= p.max_slots
      };
    });
    return map;
  }, [programAvailability]);
      ...
      <Container>
        ...
        <form>
          ...
          <Container maxWidth="100%" sx={{ backgroundColor: "#f1f1f1", border: `2px solid ${borderColor}`, padding: 4, borderRadius: 2, boxShadow: 3 }}>
                    ...
                    <FormControl fullWidth size="small" required error={!!errors.program}>
                      ...
                      >
                        ...
                        {curriculumOptions.map((item, index) => {
                          const availability = availabilityMap[item.program_id];
            ...
            <Typography style={{ fontSize: "20px", color: "#6D2323", fontWeight: "bold", mt: "-50px" }}>Person Details:</Typography>
            <hr style={{ border: "1px solid #ccc", width: "100%" }} />
            <br />
            ...
            <Box display="flex" alignItems="center" gap={2} flexWrap="nowrap" width="100%" mb={2}>
              ...
              <TextField
                ...
                onChange={handleChange}
                onBlur={() => handleUpdate(person)} disabled={person.lrnNumber === "No LRN Number"}
                size="small"
                sx={{ width: 220 }}
              ...
              <TextField
                ...
                onBlur={() => handleUpdate(person)} error={Boolean(errors.gender)}
                sx={{ width: 150 }}
                InputProps={{ sx: { height: 40 } }}
              ...
              {person.pwdMember === 1 && (
                <>
                  ...
                  <TextField
                    ...
                    onChange={handleChange}
                    onBlur={() => handleUpdate(person)} required={person.pwdMember === 1}
            ...
            <Box display="flex" gap={2} mb={2}>
              ...
              <Box flex={1}>
                ...
                <TextField
                  ...
                  onChange={handleChange}
                  onBlur={() => handleUpdate(person)} error={!!errors.birthOfDate}
              ...
              <Box flex={1}>
                ...
                <FormControl fullWidth size="small" required error={!!errors.citizenship}>
                  ...
                  <Select
                    ...
                    onChange={handleChange}
                    onBlur={() => handleUpdate(person)} label="Citizenship" // Required for floating label
                  >
                    <MenuItem value="">
              ...
              <Box flex={1}>
                ...
                <FormControl fullWidth size="small" required error={!!errors.religion}>
                  ...
                  <Select
                    ...
                    onChange={handleChange}
                    onBlur={() => handleUpdate(person)} label="Religion" // Enables floating label
                  >
                    <MenuItem value="">
              ...
              <Box flex={1}>
                ...
                <FormControl fullWidth size="small" required error={!!errors.civilStatus}>
                  ...
                  <Select
                    ...
                    onChange={handleChange}
                    onBlur={() => handleUpdate(person)} label="Civil Status"
                  >
                    <MenuItem value="">
                      <em> Select Status </em>
                    </MenuItem>
              ...
              <Box flex={1}>
                ...
                <FormControl fullWidth size="small" required error={!!errors.tribeEthnicGroup}>
                  ...
                  <Select
                    ...
                    onChange={handleChange}
                    onBlur={() => handleUpdate(person)} label="Tribe/Ethnic Group"
                  >
                    <MenuItem value="">
